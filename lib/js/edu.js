...
xx.module("edu", function (apod) {
  ...
  function initTopVariables() {
    ...
    tbh = topdiv.offsetHeight + q._("bottomdiv").offsetHeight;
    // also init the top of the wrappermask and dialogmask to be the top of the wrapper
    q._("wrappermask").style.top = topdiv.offsetHeight + "px";
    q._("wrappermask").style.bottom = q._("bottomdiv").offsetHeight + "px";
  }
  ...
  //   let ele = q.qs('#wrapper');
  //   let ele2 = document.body;
  //   let ele3 = wrapper;
  //   let ele4 = 'wrapper';
  //   let ele5 = q.qs('document.body');
  //   q.delegate(ele, "click", ".info_class", function clickOnInfoClassInWrapper(e) {
  //     // this is executed when you click on any item of info which is displayed in the wrapper
  //     this.nextElementSibling.nextElementSibling.classList.toggle("nodisplay");
  //     common.checkHeight();
  //     common.checkWidth();
  ...
  //   q._("gamecontainermask").classList.remove("nodisplay");
  // }
  function gc_enable() {
  ...
  function setVolume() {
    ...
    // for(let ele of q.qa('#clips0 audio')) ele.volume = vol;
    // for(let ele of q.qa('#clips1 audio')) ele.volume = vol;
    // q.qa("#clips0 audio").forEach((ele) => {
    //   ele.volume = vol;
    // });
    // q.qa("#clips1 audio").forEach((ele) => {
    //   ele.volume = vol;
    // });
